...
<body>
	<c:if test="${!authInfo.nickname.equals(formData.nickname) }">
		<script>
			alert("잘못된 접근입니다."+formData.nickname);
			location.href="${pageContext.request.contextPath}/userBoard/read/"+${formData.seq};
		</script>
	</c:if>
	<div id="header"></div>
	<section>
